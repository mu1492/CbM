...
class Adxl355
{
    ...
    private:
        typedef enum : uint8_t
        {
            ...
            ADXL355_REG_PART_ID         = 0x02,
            ADXL355_REG_REV_ID          = 0x03,
            ...
            ADXL355_REG_SHADOW_FIRST    = 0x50,
            ADXL355_REG_SHADOW_LAST     = 0x54
        }Adxl355Reg;
        ...
        typedef enum : uint8_t
        {
            ...
            RANGE_PM8G = 0x03,              //!< Range is +/-8 g
            RANGE_PM4G = 0x02,              //!< Range is +/-4 g
            RANGE_PM2G = 0x01               //!< Range is +/-2 g
        }Range;
    ...
    public:
        typedef enum : uint8_t
        {
            ADXL355_I2C_ADDRESS_PRIMARY     = 0x1d,         //!< ADXL355 default I2C 7-bit address
            ADXL355_I2C_ADDRESS_SECONDARY   = 0x53          //!< ADXL355 alternative I2C 7-bit address
        }Adxl355I2cAddress;

        static const uint8_t REV_ID = 0x01; //!< ADXL355 chip revision ID
